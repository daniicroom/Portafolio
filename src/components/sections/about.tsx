      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div data-aos="fade-left">
            ...
            <p className="text-gray-600 mb-4">{RESUME_DATA.summary}</p>
            
            <button
              onClick={() => import("../pdf/ViewerWrapper").then((m) => m.viewPDFInNewTab())}
              className="bg-[var(--primary-color)] text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors mr-4"
            >
              Ver CV
            </button>
            ...
            <button
              onClick={() =>
                import("../pdf/download-pdf").then((m) =>
                  m.generatePDF()
                )
              }
